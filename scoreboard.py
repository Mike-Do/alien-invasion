# Create the display for the current score, the high score, 
# level, and number of ships remaining.
...
class Scoreboard():
    ...
    def prep_level(self, stats):
        ...
        self.level_image = self.font.render(str(stats.level), True, 
            self.text_color, self.ai_settings.bg_color)
    ...
    def prep_ships(self, stats):
        """Show how many ships are left."""
        self.ships = Group()
        for ship_number in range(stats.ships_left):
